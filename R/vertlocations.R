...
#' }
vertlocations <- function(key="r_B68F3", grp="fish", t = NA, l = NA, c = NA, d = NA, 
                           q = NA, p = NA, m = NA, 
                           url = "http://www.fishnet2.net/api/v1/locations/?") 
{
  if(grp=="bird")
    url = "http://ornis2.ornisnet.org/api/v1/locations/?"
  if(grp=="herp")
    url = "http://herpnet2.org/api/v1/locations/?"
